...
class CompiledKeys {
  ...
  static compile(instructions, pubkey) {
    ...
    const pubkeyMeta = getOrInsertDefault(payer);
    pubkeyMeta.isSigner = true;
    pubkeyMeta.isWritable = true;
...
class Message {
  ...
  static compile(args) {
    const compiledKeys = CompiledKeys.compile(args.instructions, args.pubkey);
...
class TransactionMessage {
  ...
  static decompile(message, args) {
    ...
    const pubkey = accountKeys.get(0);
